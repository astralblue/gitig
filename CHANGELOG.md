...
* fix: add m2r2 to docs dependencies for Read the Docs

- Add m2r2 to docs optional dependencies for changelog conversion
- Keep script strict - fail fast if dependencies missing
- Better to fail build than serve docs with missing changelog

This ensures Read the Docs has all required dependencies for
automatic changelog RST generation. ([`14b9c2f`](https://github.com/astralblue/ign/commit/14b9c2ff62ab421344deaafb9d2c7a33d1f3f599))

* fix: disable build command in semantic-release to avoid dependency issues

The build command was failing because m2r2 is not available in the
semantic-release container. Since Read the Docs handles RST conversion
automatically via .readthedocs.yaml, we don't need it in semantic-release.

This enables clean automated releases without dependency conflicts. ([`fbc339c`](https://github.com/astralblue/ign/commit/fbc339c788d9f8c4d9a3772ed03036bafd118530))

### Features

* feat: perfect semantic-release automation with local workflow support

- Configure semantic-release to automatically run md-to-rst conversion
- Add pyproject-local.toml for prefixed tag workflow compatibility
- Resolve kacl-cli format compatibility with Keep a Changelog standard
- Implement hybrid approach: manual changelog + automated RST generation
- Remove manual conversion steps from GitHub Actions workflow
- Update documentation with release management best practices

This enables both automated releases and local development with
personal git workflow preferences while maintaining compatibility.

🤖 Generated with [Claude Code](https://claude.ai/code)

Co-Authored-By: Claude <noreply@anthropic.com> ([`23cad4e`](https://github.com/astralblue/ign/commit/23cad4e0e40d89544eaa334cf9558b4d7a7745e9))

### Refactoring

* refactor: make docs/changelog.rst a build artifact

- Remove docs/changelog.rst from git tracking
- Add to .gitignore as auto-generated file
- Read the Docs will generate it automatically via .readthedocs.yaml
- Keeps repository clean while maintaining documentation automation ([`d7f5791`](https://github.com/astralblue/ign/commit/d7f579117ae7accd2bb8e802c6978a1e026894e9))
...
* chore: release 0.1.4 ([`6afd894`](https://github.com/astralblue/ign/commit/6afd894e647f398812594e6ac5be13f638cf0362))
